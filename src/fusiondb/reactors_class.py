...
from fusiondb.geometry.plasma_geometry import (
    FRC_SHAPE_RELATIONS,
    GEOMETRY_RELATIONS,
...
from fusiondb.plasma_parameters import PLASMA_RELATIONS
from fusiondb.power_exhaust.power_exhaust import PSEP_RELATIONS
from fusiondb.confinement.scalings import CONFINEMENT_RELATIONS_BY_NAME
from fusiondb.relations_values import PRIORITY_RELATION, Relation, RelationSystem
from fusiondb.relations_util import REL_TOL_DEFAULT


@dataclass
class Reactor:
    ALLOWED_REACTOR_CLASSES: ClassVar[tuple[str, ...]] = ("ARC", "STEP", "DEMO", "Example")
