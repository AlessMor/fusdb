...
from fusdb_pyomo.registry import (
    DD_HE3_ENERGY_J,
    DD_N_ENERGY_J,
    DD_P_ENERGY_J,
    DD_T_ENERGY_J,
...
from ..reactions.DHe3 import sigmav_DHe3_BoschHale
from ..reactions.DT import sigmav_DT_BoschHale
...
def fusion_power_tt(Rr_TT: float) -> Any:
