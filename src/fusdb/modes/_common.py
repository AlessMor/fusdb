    ...
    result.update(
        {
            ...
            "variables": system.variables_by_name,
...
def record_uninitialized_failure(system: Any, result: dict[str, Any]) -> bool:
    ...
    required = system._required_uninitialized_free_variables()
    if not required:
        return False
    ...
    result["uninitialized_free_variables"] = list(system._uninitialized_free_variables)
    return True
