...
def tau_E_itpa20_il_high_z(I_p: float, B0: float, P_loss_MW: float, dnla19: float, aion: float, R: float) -> float:
...
def tau_E_itpa_2018_std5_gls(
    I_p: float, B0: float, dnla19: float, P_loss_MW: float, R: float, eps: float, kappa_A: float, afuel: float
) -> float:
...
def tau_E_I_Mode_y2(I_p: float, B0: float, P_loss_MW: float, dnla19: float) -> float:
    """
    ...
    P_loss_MW (float): Net heating power [MW]
...
def tau_E_iter89P(
    I_p: float, R: float, a: float, kappa_sep: float, dnla20: float, B0: float, afuel: float, P_loss_MW: float
) -> float:
    """
...
def tau_E_iter89P_ka(
    I_p: float, R: float, a: float, kappa_A: float, dnla20: float, B0: float, afuel: float, P_loss_MW: float
) -> float:
    """
