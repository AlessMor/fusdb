...
def amjuel_h4_3_2_3r_h2_mar_via_h2_rate(n_e_edge: Any, T_edge: Any) -> Any:
    ...
    """
    return evaluate_amjuel_h4_rate("polynomialfit_AMJUEL-H4-3.2.3r_H2-mar-via-h2-plus", n_e_edge, T_edge)
...
def amjuel_h4_3_2_3d_h2_mad_via_h2_rate(n_e_edge: Any, T_edge: Any) -> Any:
    ...
    """
    return evaluate_amjuel_h4_rate("polynomialfit_AMJUEL-H4-3.2.3d_H2-mad-via-h2-plus", n_e_edge, T_edge)
...
def amjuel_h4_3_2_3i_h2_mai_via_h2_rate(n_e_edge: Any, T_edge: Any) -> Any:
    ...
    - in P (v), Te = Tp to remove Tp dependence in P (v), EH2 = 0:1 eV .
    """
    return evaluate_amjuel_h4_rate("polynomialfit_AMJUEL-H4-3.2.3i_H2-mai-via-h2-plus", n_e_edge, T_edge)